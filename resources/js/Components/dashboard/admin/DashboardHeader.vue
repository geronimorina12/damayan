...
const prevName = () => {
  ...
  router.get(route("filterAnalytics.next", { id: prevMember.member_id }), {}, { preserveScroll: true });
};
...
const nextName = () => {
  ...
  router.get(route("filterAnalytics.next", { id: nextMember.member_id }), {}, { preserveScroll: true });
};
</script>
